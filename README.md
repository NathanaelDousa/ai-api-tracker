...
Monitor your AI API spending and credit balances directly on your Stream Deck keys. Supports OpenAI, Claude (Anthropic), Gemini (Google), and DeepSeek from a single plugin.
